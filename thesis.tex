...
\usepackage{hvfloat}
\usepackage{lipsum} % TODO: Remove after format testing
\usepackage{scrlayer}
\DeclareNewLayer[
  background,
  innermargin,
...
\chair{Stephen Scott }
\cochair{Juan Cui}
\othermembers{Professors Vinod Variyam \\
  Bertrand Clarke}
...
% each entry in the Table of figures and table of tables should be at most one sentence long
\clearpage
\listoffigures
\clearpage
\listoftables
...
\dsp % Rest of the document will be double spaced
\pagestyle{headings}
\include{chap1}
\include{chap2}
